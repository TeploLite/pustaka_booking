...
class Pinjam extends CI_Controller { 
    ...
    public function pinjamAct() { 
        ...
        $this->db->query("UPDATE buku, detail_pinjam SET buku.dipinjam=buku.dipinjam-1, buku.stok=buku.stok+1 WHERE buku.id=detail_pinjam.id_buku AND no_pinjam='$no_pinjam'"); 
